...
import { Glyph, FormField, FormInput, FormIconField } from 'elemental'
...
let Autocomplete = React.createClass({
  ...
  propTypes: {
    ...
    elemental_glyph: React.PropTypes.string,
    elemental_size: React.PropTypes.string, // "sm", "lg"
    elemental_iconPosition: React.PropTypes.string,
    elemental_iconColor: React.PropTypes.string
  },
  ...
  getDefaultProps () {
    return {
      ...
      renderMenu (items, value, style) {
      	if (this.menuStyle) {
      		// babel-cli choking on the ...splat
      		Object.keys(this.menuStyle).forEach( KEY => {
      			style[KEY] = this.menuStyle[KEY]
      		});
      	}
      ...
      elemental_iconPosition: 'left',
      elemental_iconColor: 'default'
    }
  },
  ...
  render () {
    ...
    if (this.props.elemental_size) {
    	ip.size = this.props.elemental_size;
    }
    
    //iconPosition="left" iconColor="default" iconKey="mail"
    if (this.props.elemental_glyph) {
		return ( 
		  <div style={{display: 'inline-block'}}>
			<FormIconField iconPosition={this.props.elemental_iconPosition} iconColor={this.props.elemental_iconColor} iconKey={this.props.elemental_glyph}>
				<FormInput
		...
		return ( 
		  <div style={{display: 'inline-block'}}>
			<FormField htmlFor={this.id} ref="label" label={this.props.labelText}>
				<FormInput
				  {...this.props.inputProps}
				  {...ip}
				/>
